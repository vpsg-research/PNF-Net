...
from net.FFNet import Net
from utils.EITL_utiles import cvtColor, preprocess_input, resize_image
...
class SegFormer_Segmentation(object):
    ...
    def generate(self, onnx=False):
        ...
        self.net = torch.nn.DataParallel(self.net)   # 使用DataParallel将模型加载到多个GPU上
    ...
    def detect_image_resize(self, image):
        ...
        with torch.no_grad():
            ...
            pr = pr.sigmoid().data.cpu().numpy().squeeze()
