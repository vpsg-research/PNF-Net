...
class PolypObjDataset(data.Dataset):
    def __init__(self, image_root, gt_root, edge_root, trainsize, type_='train'):
        ...
        self.images = [f for f in os.listdir(image_root) if f.endswith('.jpg') or f.endswith('.tif') or f.endswith('.bmp')]
    ...
    def __getitem__(self, index):
        image = self.rgb_loader(os.path.join(self.image_root, self.images[index])) # PIL Image
        # print(image.size)
        ...
        try:
            ...
            print(f'gt: {self.gts[index]}')
            print(f'eg: {self.egs[index]}')
...
class test_dataset:
    def __init__(self, image_root, gt_root, testsize):
        ...
        self.images = [f for f in os.listdir(image_root) if f.endswith('.jpg') or f.endswith('.png') or f.endswith('.tif') or f.endswith('.bmp') or f.endswith('.jpeg') or f.endswith('.TIF')]
        self.gts = [f for f in os.listdir(gt_root) if f.endswith('.tif') or f.endswith('.png') or f.endswith('.tif') or f.endswith('.bmp') or f.endswith('.PNG')]
        self.images = sorted(self.images)
        self.gts = sorted(self.gts)
    ...
    def load_data(self):
        ...
        image_for_post = self.rgb_loader(os.path.join(self.image_root, self.images[self.index]))
